            ...
            with open(file_path, "r", encoding='utf-8') as fr:
                for line in fr.readlines():
                    ...
                    for item in label_entity_list:
                        start, end = item[:2]
                        if (end - 1) == start:
                            label[start] = label_encoder.transform(item[2]) * 2 - 1
                        else:
                            label[start] = label_encoder.transform(item[2]) * 2 - 1
                            label[end - 1] = label_encoder.transform(item[2]) * 2
                            label[start + 1: end - 1] = [label_encoder.transform(item[2]) * 2] * (end - start - 2)
                        ...
                        #     label[start] = 1
                        #     label[end - 1] = 2
                        #     label[start + 1: end - 1] = [2] * (end - start - 2)
